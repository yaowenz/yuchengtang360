...
class Zend_Controller_Request_Http extends Zend_Controller_Request_Abstract
{
    ...
    public function setPathInfo($pathInfo = null)
    {
		...
		if(substr($pathInfo, -5, 5)=='.html') $pathInfo=substr($pathInfo, 1, -5);
		else if(substr($pathInfo, -4, 4)=='.htm') $pathInfo=substr($pathInfo, 1, -4); 
		//else return $this; //必须 1.html 结尾，否则跳首页
		
		//$pathInfo=str_replace("/","_",$pathInfo);//使得用 / 的url不能使用
