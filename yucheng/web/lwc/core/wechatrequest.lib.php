...
class WechatRequest{
    ...
    public static function text(&$request){
		//zx
		$tuwenList = array();
        $tuwenList[] = array('title'=>'欢迎您关注御承堂', 'description'=>'全方位的文化体验，让你身临其境的感受中国文化博大精深。', 'pic_url'=>'http://m.360antique.com/files/m3d/images/welcome.png', 'url'=>'http://m.360antique.com/');
		$itemList = array();
